...
ROUTE_SCOPES: Mapping[tuple[str, str], tuple[str, ...]] = {
    ("GET", "/{workspace_id}"): PROJECTS_READ,
    ("PATCH", "/{workspace_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/members"): PROJECTS_READ,
    ...
    ("GET", "/{workspace_id}/projects/{project_id}/members"): PROJECTS_READ,
    ("PUT", "/{workspace_id}/projects/{project_id}/members/{user_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/projects/{project_id}/members/{user_id}"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/projects/{project_id}/statuses"): PROJECTS_READ,
    ("POST", "/{workspace_id}/projects/{project_id}/statuses"): NO_KEY_ACCESS,
    ("PATCH", "/{workspace_id}/projects/{project_id}/statuses/{status_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/projects/{project_id}/statuses/{status_id}"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/projects/{project_id}/labels"): PROJECTS_READ,
    ("POST", "/{workspace_id}/projects/{project_id}/labels"): NO_KEY_ACCESS,
    ("PATCH", "/{workspace_id}/projects/{project_id}/labels/{label_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/projects/{project_id}/labels/{label_id}"): NO_KEY_ACCESS,
    ...
    ("GET", "/{workspace_id}/cycles"): PROJECTS_READ,
    ("POST", "/{workspace_id}/cycles"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/cycles/{cycle_id}"): PROJECTS_READ,
    ("PATCH", "/{workspace_id}/cycles/{cycle_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/cycles/{cycle_id}"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/milestones"): PROJECTS_READ,
    ("POST", "/{workspace_id}/milestones"): NO_KEY_ACCESS,
    ("GET", "/{workspace_id}/milestones/{milestone_id}"): PROJECTS_READ,
    ("PATCH", "/{workspace_id}/milestones/{milestone_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/milestones/{milestone_id}"): NO_KEY_ACCESS,
    ...
    ("GET", "/{workspace_id}/projects/{project_id}/github-transitions"): PROJECTS_READ,
    ("POST", "/{workspace_id}/projects/{project_id}/github-transitions"): NO_KEY_ACCESS,
    ("PATCH", "/{workspace_id}/projects/{project_id}/github-transitions/{transition_id}"): NO_KEY_ACCESS,
    ("DELETE", "/{workspace_id}/projects/{project_id}/github-transitions/{transition_id}"): NO_KEY_ACCESS,
