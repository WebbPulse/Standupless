"""The github-events consumer's entrypoint, run as its own Lambda function.
...
DOMAIN = Domain(
    ...
    title="Standupless integrations events consumer",
    load_routers=lambda: [],
...
def _routers() -> "list[APIRouter]":
    """This consumer's router alone, handling the queued GitHub deliveries."""
    from app.domains.integrations.consumers.events import build_router
