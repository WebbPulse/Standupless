"""The search consumer's entrypoint, run as its own Lambda function.
...
def _routers() -> "list[APIRouter]":
    """The search consumer's router alone."""
    from app.domains.views.consumers.search import build_router
